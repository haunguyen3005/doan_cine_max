<aside class="sidebar">
    <a href="#" class="logo">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 logo-icon">
    ...
    <ul class="menu">
        <li class="menu-item">
            <a href="#" class="menu-link">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 menu-icon">
        ...
        <li class="menu-item">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 menu-icon">
                ...
                <span class="menu-text">Quản lý vé</span>
            </a>
        </li>
        <li class="menu-item">
            <a href="#" class="menu-link">
